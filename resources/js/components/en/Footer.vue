    ...
    <div class="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <h5 style="padding:0 20px;">Sitemap</h5>
                    <div class="menu">
...
.footer .link-menu li svg {
    fill: #85C2F7;
}
.footer .link-menu li svg:hover {
    fill: #000;
}
</style>
