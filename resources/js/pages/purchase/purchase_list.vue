...
<script>    
    ...
    export default {
        ...
        created() {
            ...
            this.getPurchaseListById(user_id)
        },
        methods: {            
            ...
            async getPurchaseListById(id){
                const {data} = await axios.get('/api/get/purchase/customer/purchase_list/'+id)
